...
export default {
  ...
  "organizationName": "MeteorBurn",
  "projectName": "YouTube-Dorgen-Docs",
  "onBrokenLinks": "warn",
    ...
    [
      "classic",
      {
        "docs": {
          ...
          "editUrl": "https://github.com/MeteorBurn/YouTube-Dorgen-Docs/edit/main"
        },
        "blog": {
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2025 Meteorburn. Документация создана с помощью Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
